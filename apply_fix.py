#!/usr/bin/env python3
"""
Script de correction rapide pour le problème d'import MLflow.
À exécuter à la racine du projet : python apply_fix.py
"""
import os
import shutil

def apply_mlflow_fix():
    """Applique la correction pour le problème d'import MLflow."""
    
    print("🔧 Application de la correction MLflow...")
    
    # Sauvegarder l'ancien fichier
    original_file = "src/models/train.py"
    backup_file = "src/models/train.py.backup"
    
    if os.path.exists(original_file):
        shutil.copy2(original_file, backup_file)
        print(f"💾 Sauvegarde créée: {backup_file}")
    
    # Contenu corrigé simplifié
    corrected_content = """'''
...
"""
    ...
    try:
        ...
        print(f"✅ Fichier corrigé: {original_file}")
        return True
...
def main():
    ...
    print("🔧 Correction rapide du problème d'import MLflow")
    print("="*50)
    
    success = apply_mlflow_fix()
    
    if success:
        print("\n✅ CORRECTION APPLIQUÉE!")
        print("\n📋 Changements effectués:")
        print("   ✅ Imports MLflow corrigés")
        print("   ✅ Gestion d'erreurs améliorée")
        print("   ✅ Compatibilité renforcée")
        print("   💾 Sauvegarde de l'ancien fichier (.backup)")
        
        print("\n🧪 PROCHAINES ÉTAPES:")
        print("1. Relancer le test:")
        print("   python test_training_pipeline.py")
        
        print("\n2. Si le test passe, valider l'entraînement:")
